...
export const COURSES: Course[] = [
  { id: "c-001", title: "Python for Data Analysis", description: "Learn data manipulation and visualisation using Pandas, NumPy, and Matplotlib.", category: "technical", status: "active", deliveryMode: "online", instructor: "Dr. Eze Nnamdi", durationHours: 20, capacity: 30, enrolled: 24, startDate: "2026-02-01", endDate: "2026-03-15", tags: ["python", "data", "analytics"], createdAt: "2025-12-01" },
  { id: "c-002", title: "Leadership Essentials", description: "Develop core leadership skills including communication, delegation, and conflict resolution.", category: "leadership", status: "active", deliveryMode: "in_person", instructor: "Mrs. Adaeze Okonkwo", durationHours: 12, capacity: 20, enrolled: 15, startDate: "2026-02-10", endDate: "2026-02-12", tags: ["leadership", "management"], createdAt: "2025-12-10" },
  { id: "c-003", title: "Anti-Money Laundering (AML) 2026", description: "Mandatory annual compliance training covering AML regulations and reporting obligations.", category: "compliance", status: "active", deliveryMode: "online", instructor: "Compliance Team", durationHours: 4, enrolled: 183, startDate: "2026-01-01", endDate: "2026-03-31", tags: ["AML", "compliance", "mandatory"], createdAt: "2025-11-01" },
  { id: "c-004", title: "Effective Communication at Work", description: "Build skills for clear written and verbal communication in professional settings.", category: "soft_skills", status: "active", deliveryMode: "hybrid", instructor: "Babatunde Lawal", durationHours: 8, capacity: 25, enrolled: 18, startDate: "2026-02-15", endDate: "2026-02-16", tags: ["communication", "soft skills"], createdAt: "2025-12-15" },
  { id: "c-005", title: "New Employee Orientation", description: "Comprehensive onboarding programme for all new joiners.", category: "onboarding", status: "active", deliveryMode: "hybrid", instructor: "HR Team", durationHours: 6, enrolled: 12, tags: ["onboarding", "orientation"], createdAt: "2024-01-01" },
  { id: "c-006", title: "Product Roadmap Q1 2026", description: "Internal product training on the Q1 2026 product roadmap and feature set.", category: "product", status: "draft", deliveryMode: "online", instructor: "Product Team", durationHours: 3, enrolled: 0, tags: ["product", "roadmap"], createdAt: "2026-01-10" },
];

export const ENROLLMENTS: Enrollment[] = [
  { id: "en-001", courseId: "c-001", courseName: "Python for Data Analysis", employeeName: "Emeka Nwosu", employeeInitials: "EN", employeeDept: "Engineering", status: "in_progress", progress: 60, enrolledAt: "2026-02-01", score: undefined },
  { id: "en-002", courseId: "c-001", courseName: "Python for Data Analysis", employeeName: "Tunde Badmus", employeeInitials: "TB", employeeDept: "Engineering", status: "enrolled", progress: 0, enrolledAt: "2026-02-01" },
  ...
  { id: "en-004", courseId: "c-003", courseName: "Anti-Money Laundering (AML) 2026", employeeName: "Halima Musa", employeeInitials: "HM", employeeDept: "Human Resources", status: "completed", progress: 100, enrolledAt: "2026-01-05", completedAt: "2026-01-06", score: 92 },
  { id: "en-005", courseId: "c-003", courseName: "Anti-Money Laundering (AML) 2026", employeeName: "Aisha Garba", employeeInitials: "AG", employeeDept: "Legal", status: "completed", progress: 100, enrolledAt: "2026-01-05", completedAt: "2026-01-07", score: 96 },
  { id: "en-006", courseId: "c-003", courseName: "Anti-Money Laundering (AML) 2026", employeeName: "Ngozi Obi", employeeInitials: "NO", employeeDept: "Finance", status: "in_progress", progress: 50, enrolledAt: "2026-01-10" },
