...
export const ONBOARDING_RECORDS: OnboardingRecord[] = [
  // ── Before start date — offer, docs, equipment ──
  {
    id: "onb-001",
    ...
    stage: "pre_boarding",
    status: "in_progress",    workflowTemplateId: WF_ID,
  ...
  },
  {
    ...
    stage: "pre_boarding",
    status: "not_started",    workflowTemplateId: WF_ID,
    workflowName: WF_NAME,
    completedTasks: 0,
    totalTasks: 3,
    welcomeEmailSent: true,
  ...
  },
  {
    ...
    stage: "thirty_day",
    status: "overdue",    workflowTemplateId: WF_ID,
    workflowName: WF_NAME,
    completedTasks: 0,
    totalTasks: 3,
    welcomeEmailSent: true,
