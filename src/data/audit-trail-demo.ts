...
export const ALL_ENTRIES: AuditEntry[] = [
  { id: "ae-001", sessionId: "s-001", userId: "u-01", userName: "Adaeze Okonkwo", userInitials: "AO", userRole: "HR Admin", actionType: "login", module: "auth", description: "User logged in successfully", endpoint: "/api/auth/login", httpMethod: "POST", httpStatus: 200, ipAddress: "102.90.10.11", location: "Lagos, Nigeria", responseTimeMs: 210, timestamp: "2026-01-15T08:02:00Z", isSuspicious: false },
  { id: "ae-002", sessionId: "s-001", userId: "u-01", userName: "Adaeze Okonkwo", userInitials: "AO", userRole: "HR Admin", actionType: "view", module: "employees", description: "Viewed employee list", endpoint: "/api/employees", httpMethod: "GET", httpStatus: 200, ipAddress: "102.90.10.11", location: "Lagos, Nigeria", responseTimeMs: 145, timestamp: "2026-01-15T08:05:00Z", isSuspicious: false },
  { id: "ae-003", sessionId: "s-001", userId: "u-01", userName: "Adaeze Okonkwo", userInitials: "AO", userRole: "HR Admin", actionType: "update", module: "employees", description: "Updated employee profile: Emeka Nwosu", endpoint: "/api/employees/e-007", httpMethod: "PATCH", httpStatus: 200, ipAddress: "102.90.10.11", location: "Lagos, Nigeria", responseTimeMs: 320, timestamp: "2026-01-15T08:12:00Z", isSuspicious: false, resourceId: "e-007" },
  { id: "ae-004", sessionId: "s-001", userId: "u-01", userName: "Adaeze Okonkwo", userInitials: "AO", userRole: "HR Admin", actionType: "export", module: "reports", description: "Exported payroll summary report", endpoint: "/api/reports/payroll/export", httpMethod: "GET", httpStatus: 200, ipAddress: "102.90.10.11", location: "Lagos, Nigeria", responseTimeMs: 980, timestamp: "2026-01-15T08:30:00Z", isSuspicious: false },
  { id: "ae-005", sessionId: "s-001", userId: "u-01", userName: "Adaeze Okonkwo", userInitials: "AO", userRole: "HR Admin", actionType: "logout", module: "auth", description: "User logged out", endpoint: "/api/auth/logout", httpMethod: "POST", httpStatus: 200, ipAddress: "102.90.10.11", location: "Lagos, Nigeria", responseTimeMs: 85, timestamp: "2026-01-15T09:00:00Z", isSuspicious: false },
  { id: "ae-006", sessionId: "s-002", userId: "u-02", userName: "Chidi Eze", userInitials: "CE", userRole: "Manager", actionType: "login", module: "auth", description: "User logged in successfully", endpoint: "/api/auth/login", httpMethod: "POST", httpStatus: 200, ipAddress: "41.58.200.5", location: "Abuja, Nigeria", responseTimeMs: 190, timestamp: "2026-01-15T09:10:00Z", isSuspicious: false },
  { id: "ae-007", sessionId: "s-002", userId: "u-02", userName: "Chidi Eze", userInitials: "CE", userRole: "Manager", actionType: "approve", module: "leave", description: "Approved leave request for Halima Musa", endpoint: "/api/leave/lr-012/approve", httpMethod: "POST", httpStatus: 200, ipAddress: "41.58.200.5", location: "Abuja, Nigeria", responseTimeMs: 260, timestamp: "2026-01-15T09:20:00Z", isSuspicious: false, resourceId: "lr-012" },
  { id: "ae-008", sessionId: "s-002", userId: "u-02", userName: "Chidi Eze", userInitials: "CE", userRole: "Manager", actionType: "reject", module: "leave", description: "Rejected leave request for Bola Ahmed", endpoint: "/api/leave/lr-015/reject", httpMethod: "POST", httpStatus: 200, ipAddress: "41.58.200.5", location: "Abuja, Nigeria", responseTimeMs: 240, timestamp: "2026-01-15T09:25:00Z", isSuspicious: false, resourceId: "lr-015" },
  { id: "ae-009", sessionId: "s-003", userId: "u-03", userName: "Ngozi Obi", userInitials: "NO", userRole: "HR Admin", actionType: "login", module: "auth", description: "User logged in from unusual location", endpoint: "/api/auth/login", httpMethod: "POST", httpStatus: 200, ipAddress: "176.32.99.200", location: "Dublin, Ireland", responseTimeMs: 310, timestamp: "2026-01-15T10:00:00Z", isSuspicious: true },
  { id: "ae-010", sessionId: "s-003", userId: "u-03", userName: "Ngozi Obi", userInitials: "NO", userRole: "HR Admin", actionType: "delete", module: "documents", description: "Deleted contract document: CNT-2024-019", endpoint: "/api/documents/doc-019", httpMethod: "DELETE", httpStatus: 200, ipAddress: "176.32.99.200", location: "Dublin, Ireland", responseTimeMs: 450, timestamp: "2026-01-15T10:05:00Z", isSuspicious: true, resourceId: "doc-019" },
  { id: "ae-011", sessionId: "s-003", userId: "u-03", userName: "Ngozi Obi", userInitials: "NO", userRole: "HR Admin", actionType: "export", module: "employees", description: "Bulk exported employee records", endpoint: "/api/employees/export", httpMethod: "GET", httpStatus: 200, ipAddress: "176.32.99.200", location: "Dublin, Ireland", responseTimeMs: 1200, timestamp: "2026-01-15T10:08:00Z", isSuspicious: true },
  { id: "ae-012", sessionId: "s-004", userId: "u-04", userName: "Tunde Badmus", userInitials: "TB", userRole: "Employee", actionType: "login", module: "auth", description: "User failed login attempt", endpoint: "/api/auth/login", httpMethod: "POST", httpStatus: 401, ipAddress: "102.100.10.5", location: "Port Harcourt, Nigeria", responseTimeMs: 95, timestamp: "2026-01-15T11:00:00Z", isSuspicious: false },
  { id: "ae-013", sessionId: "s-004", userId: "u-04", userName: "Tunde Badmus", userInitials: "TB", userRole: "Employee", actionType: "login", module: "auth", description: "User logged in successfully", endpoint: "/api/auth/login", httpMethod: "POST", httpStatus: 200, ipAddress: "102.100.10.5", location: "Port Harcourt, Nigeria", responseTimeMs: 180, timestamp: "2026-01-15T11:01:00Z", isSuspicious: false },
  { id: "ae-014", sessionId: "s-004", userId: "u-04", userName: "Tunde Badmus", userInitials: "TB", userRole: "Employee", actionType: "create", module: "leave", description: "Submitted leave request", endpoint: "/api/leave", httpMethod: "POST", httpStatus: 201, ipAddress: "102.100.10.5", location: "Port Harcourt, Nigeria", responseTimeMs: 310, timestamp: "2026-01-15T11:10:00Z", isSuspicious: false },
  { id: "ae-015", sessionId: "s-005", userId: "u-01", userName: "Adaeze Okonkwo", userInitials: "AO", userRole: "HR Admin", actionType: "login", module: "auth", description: "User logged in successfully", endpoint: "/api/auth/login", httpMethod: "POST", httpStatus: 200, ipAddress: "102.90.10.11", location: "Lagos, Nigeria", responseTimeMs: 200, timestamp: "2026-01-16T08:00:00Z", isSuspicious: false },
  { id: "ae-016", sessionId: "s-005", userId: "u-01", userName: "Adaeze Okonkwo", userInitials: "AO", userRole: "HR Admin", actionType: "create", module: "recruitment", description: "Created new job requisition: Product Designer", endpoint: "/api/recruitment/requisitions", httpMethod: "POST", httpStatus: 201, ipAddress: "102.90.10.11", location: "Lagos, Nigeria", responseTimeMs: 420, timestamp: "2026-01-16T08:20:00Z", isSuspicious: false },
  { id: "ae-017", sessionId: "s-005", userId: "u-01", userName: "Adaeze Okonkwo", userInitials: "AO", userRole: "HR Admin", actionType: "update", module: "settings", description: "Updated company notification settings", endpoint: "/api/settings/notifications", httpMethod: "PUT", httpStatus: 200, ipAddress: "102.90.10.11", location: "Lagos, Nigeria", responseTimeMs: 190, timestamp: "2026-01-16T08:45:00Z", isSuspicious: false },
  { id: "ae-018", sessionId: "s-005", userId: "u-01", userName: "Adaeze Okonkwo", userInitials: "AO", userRole: "HR Admin", actionType: "view", module: "payroll", description: "Viewed payroll run details", endpoint: "/api/payroll/run-2026-01", httpMethod: "GET", httpStatus: 200, ipAddress: "102.90.10.11", location: "Lagos, Nigeria", responseTimeMs: 310, timestamp: "2026-01-16T09:00:00Z", isSuspicious: false },
];
